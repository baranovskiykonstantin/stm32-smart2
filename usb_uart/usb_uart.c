...
/******************************************************************************
 * Indication of the data exchange by LED
 *****************************************************************************/
...
void usart1_isr(void)
{
	...
	if (((USART_CR1(USART1) & USART_CR1_RXNEIE) != 0) &&
		...
		uint8_t usart_data = usart_recv(USART1);
		/* Retrieve the data from the peripheral. */
		ring_write(&uart_rx_ring, &usart_data, 1);
	}
}
...
/* 	/1* Some work after transmitting the data. *1/ */
/* } */
